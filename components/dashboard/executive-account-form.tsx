      ...
      <label className="grid gap-1 text-xs font-medium">
        ...
        <select name="executivePosition" required className={inputClass}>
          {[
            ...
            "joint_finance_secretary",
            "robotics_secretary",
            "space_&_astronomy_secretary",
            "research_&_publication_secretary",
            "joint_research_&_publication_secretary",
            "programming_&_software_secretary",
            "joint_programming_&_software_secretary",
            "office_secretary",
            "event_management_secretary",
            "graphics_design_secretary",
            "media_secretary",
            "outreach_&_sponsor_management_secretary",
            "executive_member",
          ].map((position) => (
