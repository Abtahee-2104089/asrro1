...
export const executivePosition = v.union(
  ...
  v.literal("joint_organizing_secretary"),
  v.literal("finance_secretary"),
  v.literal("joint_finance_secretary"),
  v.literal("robotics_secretary"),
  v.literal("space_astronomy_secretary"),
  v.literal("research_publication_secretary"),
  v.literal("joint_research_publication_secretary"),
  v.literal("programming_software_secretary"),
  v.literal("joint_programming_software_secretary"),
  v.literal("office_secretary"),
  v.literal("event_management_secretary"),
  v.literal("graphics_design_secretary"),
  v.literal("media_secretary"),
  v.literal("outreach_sponsor_management_secretary"),
